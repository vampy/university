...
bool Controller::idExists(unsigned int id) { return this->repository->exists(id); }

bool Controller::undo() { return this->repository->undo(); }

Repository* Controller::getRepository() { return this->repository; }
