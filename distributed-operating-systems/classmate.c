/*
    Se creaaza un vector de 10 elemente si 10 threaduri. Fiecare thread primeste ca argumetn v[i] si afiseaza 
    valoarea pe pozitia i in fisier(acesta va astepta dupa celelalte threaduri sa termine), adica continutul fisierul va fi 0123456789
*/
