...
public class BooksMainTableModel extends AbstractTableModel
{
    private List<Book> books;
    private String[] cols = {"Id", "Title", "Author", "Loaned"};

    public BooksMainTableModel(List<Book> books)
    {
        this.books = books;
    }
    ...
    public Object getValueAt(int rowIndex, int columnIndex)
    {
        switch (columnIndex)
        {
            ...
            case 3:
                return books.get(rowIndex).isLoaned();
        }
