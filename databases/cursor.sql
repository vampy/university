...
DECLARE cursor_names CURSOR FOR SELECT id, [upgrade_proc], [revert_proc] FROM [schema_migrations];

OPEN cursor_names;
 
FETCH NEXT FROM cursor_names INTO @id, @upgrade_proc, @revert_proc;
