...
public:
    ...
    */
    bool hasNext()
    {
        return currentPointer < map->getLength();
    }
...
public:
    ...
    */
    MapVector::Iterator<TKey, TValue>* getIterator()
    {
        return new MapVector::Iterator<TKey, TValue>(this);
    }
    ...
    */
    bool isEmpty() const
    {
        return (mapElements->getLength() == 0);
    }
...
protected:
    ...
    */
    ...
    {
        mapElements = new DynamicArray<Entry<TKey, TValue>*>;
    }
    ...
    void deleteInternalData()
    {
        ...
        delete mapElements; mapElements = NULL;
    }
};
}
