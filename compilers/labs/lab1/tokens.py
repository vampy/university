...
class TokenStrings:
    RESERVED_WORDS = ['int', 'float', 'char', 'array', 'while', 'do', 'begin', 'end', 'if', 'then', 'else', 'input',
                      'print']
    OTHER_TOKENS = ['[', ']', '(', ')', '<', '>', '<=', '>=', '==', '!=', '*', '/', '+', '=', ',']
    ...
    TOKEN_TYPES = {Token.INT, Token.FLOAT, Token.CHAR}
    ...
    def is_valid_identifier(string):
        return string and string not in TokenStrings.RESERVED_WORDS \
